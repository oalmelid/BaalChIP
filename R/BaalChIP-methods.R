...
setMethod(
    f="filterIntbias",
    signature="BaalChIP",
    function(.Object, simul_output=NULL, tmpfile_prefix = NULL, simulation_script="local", skipScriptRun=FALSE, verbose=TRUE){
        ...
        simures <- applySim(samples, res_per_bam, simul_output=simul_output, simulation_script=simulation_script, testingScript=testingScript, verbose=verbose)
